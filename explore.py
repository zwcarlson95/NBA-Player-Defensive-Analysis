...
player_stats22 = pd.read_csv('player_filtered_stats22.csv')
player_stats23 = pd.read_csv('player_filtered_stats23.csv')
...
#plt.savefig('heatmap23.png', dpi=300, bbox_inches='tight')
plt.show()
